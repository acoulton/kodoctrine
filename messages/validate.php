...
return array(
	...
	'matches'      => 'This field must be the same as :param2',
	'regex'        => 'This field does not match the required format',
	'exact_length' => 'This field must be exactly :param2 characters long',
	'min_length'   => 'This field must be at least :param2 characters long',
	'max_length'   => 'This field must be no more than :param2 characters long',
	'in_array'     => 'This field must be one of the available options',
	'digit'        => 'This field can only contain digits with no dots or dashes',
	'decimal'      => 'This field must be a decimal with :param2 places',
	'range'        => 'This field must be within the range of :param2 to :param3',
